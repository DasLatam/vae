...
// Componente para las tarjetas de información, ahora con un diseño más limpio
              ...
              <div className="space-y-6">
                ...
                <InfoCard title="Puntos Clave de la Ley">
                  <ul className="list-disc list-inside space-y-3">
                    <li>
                      <strong>Dos Formas de Votar:</strong> Gracias a sus modificaciones más recientes, la ley ofrece flexibilidad. Permite a los electores optar libremente entre el tradicional <strong>voto presencial</strong>, que se realiza en las embajadas y consulados, y el moderno <strong>voto por correo postal</strong>, pensado para quienes viven lejos de las sedes diplomáticas.
                    </li>
                    <li>
                      <strong>Boleta Única:</strong> Se establece el uso del sistema de Boleta Única de Papel. Este formato es idéntico para todos los países y contiene toda la oferta electoral en una sola hoja, lo que simplifica enormemente la logística de la elección y facilita al votante la emisión de su sufragio de una manera clara y estandarizada.
                    </li>
                  </ul>
                </InfoCard>
                <a href="https://www.argentina.gob.ar/normativa/nacional/ley-24007-406" target="_blank" rel="noopener noreferrer" className="bg-slate-800 text-white font-bold py-3 px-6 rounded-lg hover:bg-black transition-colors inline-flex items-center justify-center w-full sm:w-auto">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <InfoCard title="Puntos Clave del Decreto">
                  <ul className="list-disc list-inside space-y-3">
                    <li>
                      <strong>Voto Optativo:</strong> A diferencia del voto obligatorio para quienes residen en Argentina, el decreto reafirma que para los residentes en el exterior, el sufragio es un derecho y no una obligación, es decir, es de carácter <strong>optativo</strong>.
                    </li>
                    <li>
                      <strong>Requisitos para Votar:</strong> Define claramente quién es considerado elector en el exterior: todo ciudadano argentino a partir de los <strong>16 años</strong> que tenga registrado su domicilio en el extranjero en su Documento Nacional de Identidad (DNI).
                    </li>
                    <li>
                      <strong>Kit de Voto Postal:</strong> Detalla minuciosamente el contenido del paquete que el elector recibe en su casa. Este incluye la Boleta Única, un sobre de resguardo para asegurar el secreto del voto, un sobre de envío con franqueo pagado, un formulario de Declaración Jurada de Identidad y un instructivo con indicaciones claras para cada paso del proceso.
                    </li>
                  </ul>
                </InfoCard>
                <a href="https://www.argentina.gob.ar/normativa/nacional/decreto-239-2025-411116" target="_blank" rel="noopener noreferrer" className="bg-slate-800 text-white font-bold py-3 px-6 rounded-lg hover:bg-black transition-colors inline-flex items-center justify-center w-full sm:w-auto">
                  <ExternalLink className="mr-2" size={20} />
