...
export default function HomePage() {
  // Asegúrate de que este ID coincida con el de la encuesta que creaste en Supabase
  const idPrimeraEncuesta = 1; 
    ...
    <>
      ...
      <section className="bg-white py-16 border-t">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-800">Participá en Nuestra Encuesta</h2>
          <p className="text-slate-600 mt-2 mb-6 max-w-2xl mx-auto">Tu opinión nos interesa. Ayudanos a entender las tendencias del voto argentino en el exterior.</p>
          <Link href={`/encuestas/${idPrimeraEncuesta}`} className="bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors">
            Ir a la Encuesta
          </Link>
        </div>
      </section>
