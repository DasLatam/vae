...
export default function HomePage() {
  const idNuevaEncuesta = 2; // <<<--- AJUSTA ESTE ID SI ES DIFERENTE
  ...
  return (
    <>
      ...
      <section className="bg-amber-400 text-slate-900 text-center py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="max-w-2xl mx-auto">
            El paso fundamental es asegurarte de tener tu **domicilio en el exterior actualizado en tu DNI antes de Agosto de 2026** (fecha estimada).{' '}
      ...
      {/* --- Sección de Información Clave Actualizada --- */}
      <section className="py-20 sm:py-24">
         <div className="container mx-auto px-4"><div className="text-center mb-12"><h2 className="text-3xl font-bold">El Proceso para Votar en 2027</h2><p className="text-slate-600 mt-2">Fechas estimadas. ¡Suscribite para recibir confirmaciones!</p></div><div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto"><div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 text-center"><div className="text-green-500 w-12 h-12 mx-auto mb-4 flex items-center justify-center"><CheckCircle size={48} /></div><h3 className="text-xl font-semibold mb-2">1. Actualizá tu DNI</h3><p className="text-slate-600">Registrá tu domicilio en el exterior **antes de Agosto 2026**. Es clave para figurar en el padrón.</p></div><div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 text-center"><div className="text-green-500 w-12 h-12 mx-auto mb-4 flex items-center justify-center"><CheckCircle size={48} /></div><h3 className="text-xl font-semibold mb-2">2. Verificá Padrones</h3><p className="text-slate-600">Chequeá el padrón provisorio (**Feb 2027**) y el definitivo (**Abr 2027**). Si elegís voto postal, inscribite (**May 2027**).</p></div><div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 text-center"><div className="text-green-500 w-12 h-12 mx-auto mb-4 flex items-center justify-center"><CheckCircle size={48} /></div><h3 className="text-xl font-semibold mb-2">3. ¡Votá!</h3><p className="text-slate-600">Recibirás la boleta por correo (**Sep 2027**) o irás al consulado el día de la elección (**Oct 2027**).</p></div></div></div>
      </section>
      ...
      {/* --- Sección de Encuesta Actualizada --- */}
